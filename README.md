...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| tiny           | scipy     |   2 |  1 |   0.004 s |  15.00 |     —   |          0 |          0 |          0 | optimal    |
| tiny           | vanilla   |   2 |  1 |   0.003 s |  15.00 |   13.75 |          3 |          0 |          2 | optimal    |
| tiny           | no-kpp    |   2 |  1 |   0.002 s |  15.00 |   13.75 |          5 |          0 |          0 | optimal    |
...
| medium2        | milp-seed |   8 |  4 |   0.005 s |  74.00 |   72.60 |          0 |          0 |          0 | optimal    |
| medium20       | scipy     |  20 |  6 |   0.010 s |  50.00 |     —   |          0 |          0 |          0 | optimal    |
| medium20       | vanilla   |  20 |  6 |   0.040 s |  50.00 |   45.22 |      2 356 |         30 |     30 537 | optimal    |
| medium20       | no-kpp    |  20 |  6 |  13.336 s |  50.00 |   45.22 |  1 153 715 |    909 236 |  1 171 570 | optimal    |
| medium20       | milp-seed |  20 |  6 |   0.047 s |  50.00 |   45.22 |      2 276 |         28 |     29 417 | optimal    |
| medium50       | scipy     |  50 | 12 |   0.082 s |  88.00 |     —   |          0 |          0 |          0 | optimal    |
| medium50       | vanilla   |  50 | 12 |   8.430 s |  88.00 |   81.54 |    501 367 |     22 080 | 10 219 390 | optimal    |
| medium50       | no-kpp    |  50 | 12 |  82.057 s |     —  |   81.54 |  7 000 014 |  6 729 173 |          0 | **infeasible** ⚠ |
| medium50       | milp-seed |  50 | 12 |   8.586 s |  88.00 |   81.54 |    500 001 |     22 063 | 10 172 675 | optimal    |
| lan_b_zerocost | scipy     | 153 | 97 |   0.077 s | 320.00 |     —   |          0 |          0 |          0 | optimal    |
| lan_b_zerocost | vanilla   | 153 | 97 |  20.293 s | 350.00 |  231.84 |  1 000 002 |    934 341 |  1 055 232 | optimal † |
| lan_b_zerocost | milp-seed | 153 | 97 |  13.354 s | 320.00 |  231.84 |    500 001 |    489 221 |    441 939 | optimal    |

⚠ The `medium50/no-kpp` run reports *infeasible* — that is a **false
negative** caused by Stage 2.1.2 exhausting expansion options inside
the per-call node budget without ever finding a first feasible. The
problem is provably feasible (scipy finds the optimum 88).

† The `lan_b_zerocost/vanilla` row is also a false report of "optimal"
in the strict sense — the wall actually came from Stage 4 hitting its
node limit without finding an improvement on the Stage-2 incumbent
350. The true integer optimum is 320.
