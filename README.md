...
| -------------- | --------- | ---: | ---: | -------: | -----: | -------: | --------: | --------: | ---------: | -------------------- |
| tiny           | scipy     |    2 |    1 |    0.001 |  15.00 |        — |         0 |         0 |          0 | optimal              |
| tiny           | vanilla   |    2 |    1 |    0.002 |  15.00 |    13.75 |         3 |         0 |          2 | optimal              |
| tiny           | no-kpp    |    2 |    1 |    0.001 |  15.00 |    13.75 |         5 |         0 |          0 | optimal              |
| tiny           | milp-seed |    2 |    1 |    0.002 |  15.00 |    13.75 |         0 |         0 |          0 | optimal              |
| medium2        | scipy     |    8 |    4 |    0.003 |  74.00 |        — |         0 |         0 |          0 | optimal              |
| medium2        | vanilla   |    8 |    4 |    0.004 |  74.00 |    72.60 |         8 |         0 |         18 | optimal              |
| medium2        | no-kpp    |    8 |    4 |    0.003 |  74.00 |    72.60 |         8 |         0 |         18 | optimal              |
| medium2        | milp-seed |    8 |    4 |    0.008 |  74.00 |    72.60 |         0 |         0 |          0 | optimal              |
| medium20       | scipy     |   20 |    6 |    0.013 |  50.00 |        — |         0 |         0 |          0 | optimal              |
| medium20       | vanilla   |   20 |    6 |    0.053 |  50.00 |    45.22 |     2,356 |        30 |     30,537 | optimal              |
| medium20       | no-kpp    |   20 |    6 |   13.671 |  50.00 |    45.22 | 1,153,715 |   909,236 |  1,171,570 | optimal              |
| medium20       | milp-seed |   20 |    6 |    0.046 |  50.00 |    45.22 |     2,276 |        28 |     29,417 | optimal              |
| medium50       | scipy     |   50 |   12 |    0.082 |  88.00 |        — |         0 |         0 |          0 | optimal              |
| medium50       | vanilla   |   50 |   12 |    8.745 |  88.00 |    81.54 |   501,367 |    22,080 | 10,219,390 | best_within_budget † |
| medium50       | no-kpp    |   50 |   12 |   83.063 |      — |    81.54 | 7,000,014 | 6,729,173 |          0 | **infeasible** ⚠     |
| medium50       | milp-seed |   50 |   12 |    8.966 |  88.00 |    81.54 |   500,001 |    22,063 | 10,172,675 | best_within_budget † |
| lan_b_zerocost | scipy     |  153 |   97 |    0.075 | 320.00 |        — |         0 |         0 |          0 | optimal              |
| lan_b_zerocost | vanilla   |  153 |   97 |   20.395 | 350.00 |   231.84 | 1,000,002 |   934,341 |  1,055,232 | best_within_budget ‡ |
| lan_b_zerocost | milp-seed |  153 |   97 |   14.018 | 320.00 |   231.84 |   500,001 |   489,221 |    441,939 | best_within_budget † |
...
* On `medium20`: vanilla (with КПП) takes 40 ms / 2 356 lattice
  nodes; without КПП it takes **13.3   / 1,153,715 nodes** — a
  333× slowdown.
* On `medium50`: vanilla takes 8.4   / 501 k nodes; without КПП
...
* Vanilla returns `obj = 350` after ~200   wall and 10 M total
...
* With the MILP heuristic seeding Stage 2, the same instance
  finishes in ~5.5   with `obj = 320` (matching HiGHS). Stages 3
